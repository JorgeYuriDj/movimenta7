...
| “Outra” escondia qual esporte era praticado | o formulário tinha uma escolha literal sem campo de complemento | 16 atalhos comuns + opção nativa “Outro”, que permite escrever qualquer modalidade e publica o nome informado | migração idempotente do Form existente; atividades conhecidas ganham ícone próprio e as demais usam fallback sem perder o texto |
